...
class CriticalBugFixTester:
    def __init__(self, base_url="https://store-filter-fix-1.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_mode_fix(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://store-filter-fix-1.preview.emergentagent.com",
            "terms_accepted": True
        }
...
def main():
    ...
    print("Backend URL: https://store-filter-fix-1.preview.emergentagent.com/api")
