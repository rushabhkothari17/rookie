...
class CriticalBugFixTester:
    def __init__(self, base_url="https://subscription-hub-113.preview.emergentagent.com"):
...
def main():
    ...
    print("Backend URL: https://subscription-hub-113.preview.emergentagent.com/api")
