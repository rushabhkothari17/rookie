...
class CriticalBugFixTester:
    def __init__(self, base_url="https://docs-address-feature.preview.emergentagent.com"):
...
def main():
    ...
    print("Backend URL: https://docs-address-feature.preview.emergentagent.com/api")
