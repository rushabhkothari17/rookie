...
class CriticalBugFixTester:
    def __init__(self, base_url="https://api-improvements.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_mode_fix(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://api-improvements.preview.emergentagent.com",
            "terms_accepted": True
        }
...
def main():
    ...
    print("Backend URL: https://api-improvements.preview.emergentagent.com/api")
