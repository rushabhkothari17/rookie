...
class CriticalBugFixTester:
    def __init__(self, base_url="https://settings-migration-1.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_mode_fix(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://settings-migration-1.preview.emergentagent.com",
            "terms_accepted": True
        }
...
def main():
    ...
    print("Backend URL: https://settings-migration-1.preview.emergentagent.com/api")
