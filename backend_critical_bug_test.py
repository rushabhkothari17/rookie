...
class CriticalBugFixTester:
    def __init__(self, base_url="https://adaptive-layout-22.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_mode_fix(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://adaptive-layout-22.preview.emergentagent.com",
            "terms_accepted": True
        }
...
def main():
    ...
    print("Backend URL: https://adaptive-layout-22.preview.emergentagent.com/api")
