...
class CriticalBugFixTester:
    def __init__(self, base_url="https://product-refactor.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_mode_fix(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://product-refactor.preview.emergentagent.com",
            "terms_accepted": True
        }
...
def main():
    ...
    print("Backend URL: https://product-refactor.preview.emergentagent.com/api")
