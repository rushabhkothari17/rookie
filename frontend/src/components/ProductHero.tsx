...
export default function ProductHero({ product }: { product: any }) {
  ...
  return (
    <div data-testid="product-hero">
      {/* Dark hero banner */}
      <div className="relative overflow-hidden rounded-3xl px-8 py-12 md:px-14 md:py-16" style={{ backgroundColor: "var(--aa-primary)" }}>
        ...
        <div className="relative">
          <div className="mb-4 flex items-center gap-2.5">
            <div className="h-0.5 rounded-full aa-hero-accent" style={{ backgroundColor: "var(--aa-accent)", width: "48px" }} />
