...
import OverrideCodesTab from "@/components/admin/OverrideCodesTab";
...
export default function Admin() {
  ...
  const [termsStatusFilter, setTermsStatusFilter] = useState("all");
      ...
      <Tabs defaultValue="customers" className="space-y-4" data-testid="admin-tabs" onValueChange={handleTabChange}>
        ...
        <TabsContent value="terms" className="space-y-4">
          <div className="flex items-center gap-3">
            <Select value={termsStatusFilter} onValueChange={setTermsStatusFilter}>
              <SelectTrigger className="w-36" data-testid="admin-terms-status-filter"><SelectValue placeholder="All statuses" /></SelectTrigger>
              <SelectContent>
                <SelectItem value="all">All Statuses</SelectItem>
                <SelectItem value="active">Active</SelectItem>
          ...
          <div className="rounded-xl border border-slate-200 bg-white overflow-hidden">
            <Table>
              ...
              <TableBody>
                {terms.filter((t: any) => termsStatusFilter === "all" || t.status === termsStatusFilter).map((t: any) => {
                        ...
                        {linkedProducts.length === 0 ? (
                          ...
                          <div className="space-y-0.5">
                            ...
                            {linkedProducts.length > 3 && (
                              <div className="text-xs text-slate-400">+{linkedProducts.length - 3} more</div>
                            )}
                          </div>
                        )}
                      </TableCell>
