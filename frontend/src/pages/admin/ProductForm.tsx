    ...
    <div>
      ...
      {activeTab === "pricing" && (
        <div className={sectionCls}>
                ...
                <div className="space-y-3 pb-5 border-b border-slate-100 mb-6">
                  ...
                  {form.is_subscription && (
                    ...
                    <div>
                      ...
                      <Select value={form.billing_type || "prorata"} onValueChange={v => s("billing_type")(v)}>
                        <SelectTrigger data-testid="pf-billing-type"><SelectValue /></SelectTrigger>
                        <SelectContent>
                          <SelectItem value="prorata">Pro-rata — align to 1st of month</SelectItem>
                          <SelectItem value="fixed">Fixed — charge from subscription start date</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    </>
          ...
          <div className={cardCls}>
            <div>
              <label className={labelCls}>Terms & Conditions <FieldTip tip="The T&C document the customer must agree to before completing checkout for this product. Manage documents under Settings → Terms & Conditions." /></label>
