        ...
        <Table className="min-w-[900px] text-sm" data-testid="admin-subs-table">
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <th className="px-4 py-3 text-left text-xs font-medium uppercase text-slate-500">Currency</th> "date-range", { filterValue: { from: renewalFrom, to: renewalTo }, onFilter: (v: any) => { setRenewalFrom(v.from || ""); setRenewalTo(v.to || ""); }, onClearFilter: () => { setRenewalFrom(""); setRenewalTo(""); } })}
