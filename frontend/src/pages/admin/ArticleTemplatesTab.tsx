              ...
              <TableRow key={tpl.id} data-testid={`template-row-${tpl.id}`}>
                ...
                <TableCell>
                  <div className="flex gap-1">
                    ...
                    <Button variant="ghost" size="sm" className="h-7 px-2 text-[11px]" onClick={() => { setLogsUrl(`/article-templates/${tpl.id}/logs`); setShowAuditLogs(true); }} data-testid={`template-logs-${tpl.id}`}><Clock size={11} /></Button>
          ...
          <div className="space-y-4 py-2">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} maxLength={100} placeholder="e.g. Weekly Update" data-testid="template-name-input" />
              </div>
              <div className="space-y-1">
      ...
      <AlertDialog open={!!confirmDeleteTpl} onOpenChange={(open) => !open && setConfirmDeleteTpl(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={() => { handleDelete(confirmDeleteTpl!); setConfirmDeleteTpl(null); }} data-testid="confirm-article-tpl-delete">
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
