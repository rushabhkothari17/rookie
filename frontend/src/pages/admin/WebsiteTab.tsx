...
function getAuthSlideTitle(key: AuthSlide | null): string {
  const map: Record<AuthSlide, string> = {
    ...
    checkout_builder: "Checkout Page Builder", checkout_success: "Checkout & GoCardless Success",
...
function getAuthSlideDesc(key: AuthSlide | null): string {
  const map: Record<AuthSlide, string> = {
    ...
    checkout_success: "Success page content for Stripe, bank transfer, and GoCardless direct debit.",
            ...
            <>
              ...
              {(structured["Zoho"] || []).length > 0 && (
                <div className="rounded-xl border border-slate-200 bg-white p-5 mb-4">
                  <h4 className="text-xs font-semibold text-slate-600 uppercase tracking-wide mb-1">Zoho System Links</h4>
                  <p className="text-xs text-slate-400 mb-3">Partner tag and signup URLs used in the checkout flow.</p>
      ...
      >
        ...
        {authSlide === "checkout_success" && (
          <div className="space-y-4">
            ...
            <div className="border-t border-slate-100 pt-4">
              <p className="text-xs font-semibold text-slate-600 uppercase tracking-wider mb-3">GoCardless Callback Page</p>
              <div className="space-y-3">
