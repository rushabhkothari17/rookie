  ...
  return (
    <div className="space-y-4" data-testid="terms-tab">
              ...
              return (
                <TableRow key={t.id} data-testid={`admin-terms-row-${t.id}`} className="border-b border-slate-100">
                  ...
                  <TableCell>
                    ...
                    <Button variant="ghost" size="sm" className="h-6 px-2 text-[11px]" onClick={() => { setLogsUrl(`/admin/terms/${t.id}/logs`); setShowAuditLogs(true); }} data-testid={`admin-terms-logs-${t.id}`}>Logs</Button>
      ...
      <Dialog open={showEntityLogs} onOpenChange={setShowEntityLogs}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto"><DialogHeader><DialogTitle>Terms Audit Logs</DialogTitle></DialogHeader>
