      ...
      <Dialog open={showManualDialog} onOpenChange={setShowManualDialog}>
        <DialogContent><DialogHeader><DialogTitle>Create Manual Order</DialogTitle></DialogHeader>
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <label className="text-xs text-slate-500">Product <span className="text-red-400">*</span></label>
              <SearchableSelect
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-1"><label className="text-xs text-slate-500">Subtotal <span className="text-red-400">*</span></label><Input type="number" step="0.01" value={manualOrder.subtotal} onChange={e => setManualOrder({ ...manualOrder, subtotal: parseFloat(e.target.value) || 0 })} /></div>
              <div className="space-y-1"><label className="text-xs text-slate-500">Discount <span className="text-red-400">*</span></label><Input type="number" step="0.01" value={manualOrder.discount} onChange={e => setManualOrder({ ...manualOrder, discount: parseFloat(e.target.value) || 0 })} /></div>
              <div className="space-y-1"><label className="text-xs text-slate-500">Fee <span className="text-red-400">*</span></label><Input type="number" step="0.01" value={manualOrder.fee} onChange={e => setManualOrder({ ...manualOrder, fee: parseFloat(e.target.value) || 0 })} /></div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                <label className="text-xs text-slate-500">Status <span className="text-red-400">*</span></label>
