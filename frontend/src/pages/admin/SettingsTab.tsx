...
function ReminderNotificationSection() {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4" data-testid="reminder-notification-section">
      ...
      <p className="text-xs text-slate-400">Set a default number of days before renewal to send reminder emails. Individual subscriptions can override this setting.</p>
