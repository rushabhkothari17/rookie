...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12" style={{ backgroundColor: "var(--aa-bg)", color: "var(--aa-text)" }} data-testid="forgot-password-page">
