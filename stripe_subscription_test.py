...
class StripeSubscriptionModeTester:
    def __init__(self, base_url="https://payment-gateway-hub-7.preview.emergentagent.com"):
    ...
    def run_all_tests(self):
        ...
        print("Backend URL: https://payment-gateway-hub-7.preview.emergentagent.com/api")  
