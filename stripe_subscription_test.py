...
class StripeSubscriptionModeTester:
    def __init__(self, base_url="https://resource-price-rules.preview.emergentagent.com"):
    ...
    def run_all_tests(self):
        ...
        print("Backend URL: https://resource-price-rules.preview.emergentagent.com/api")  
