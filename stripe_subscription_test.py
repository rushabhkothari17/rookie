...
class StripeSubscriptionModeTester:
    def __init__(self, base_url="https://partner-billing.preview.emergentagent.com"):
    ...
    def test_stripe_subscription_checkout_mode(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://partner-billing.preview.emergentagent.com",
            "terms_accepted": True
        }
    ...
    def run_all_tests(self):
        ...
        print("Backend URL: https://partner-billing.preview.emergentagent.com/api")  
