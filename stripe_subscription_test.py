...
class StripeSubscriptionModeTester:
    def __init__(self, base_url="https://landing-page-build-10.preview.emergentagent.com"):
    ...
    def run_all_tests(self):
        ...
        print("Backend URL: https://landing-page-build-10.preview.emergentagent.com/api")  
