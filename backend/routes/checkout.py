...
async def checkout_bank_transfer(
    ...
    if checkout_type == "subscription":
        ...
        await _inc_monthly(tenant_id, "subscriptions")
    ...
    order_doc = {
        ...
        "fee": 0.0, "total": total,
        "tax_amount": _tax_amount_bt,
        "tax_rate": _tax_result_bt.get("tax_rate", 0.0),
        "tax_name": _tax_result_bt.get("tax_name"),
