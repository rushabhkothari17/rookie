...
class TestGocardlessRenewalViaHTTP:
    ...
    def test_gc_renewal_via_http_webhook(self, admin_session):
        ...
        # Seed
        db.users.insert_one({"id": user_id, "email": f"gc_http_{cust_id[:6]}@test.com", "full_name": "HTTP Test", "tenant_id": tenant_id, "is_active": True})
        db.customers.insert_one({"id": cust_id, "user_id": user_id, "tenant_id": tenant_id})
        ...
        try:
            ...
            renewal = db.orders.find_one({"gocardless_payment_id": new_pm_id, "type": "subscription_renewal"}, {"_id": 0})
            ...
            assert renewal["tenant_id"] == tenant_id
            ...
            db.orders.delete_many({"gocardless_payment_id": new_pm_id})
